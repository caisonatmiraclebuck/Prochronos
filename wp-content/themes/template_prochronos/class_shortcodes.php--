...
return $output;
	...
	$STRING = '<script src="https://maps.googleapis.com/maps/api/js?v=3&sensor=false&amp;language='.$GLOBALS['CORE_THEME']['google_lang'].'&amp;region='.$GLOBALS['CORE_THEME']['google_region'].'&key='.trim(stripslashes($GLOBALS['CORE_THEME']['googlemap_apikey'])).'" type="text/javascript"></script>';
