...
<?php } ?>
			  ...
			  switch($k){
				...
				case "2": { // LISTING DESCRIPTION
					...
					$field[$o]['type'] 		= "text";
					//$field[$o]['help'] 		= "Type in a title that best describes your watch, this title will appear on the display of the listing.";
					$field[$o]['help'] 		= $CORE->_e(array('add','99'));
					$field[$o]['class'] 	= "form-control";
					$field[$o]['required'] 	= true;
					$field[$o]['ontop'] 	= true;
					...
					$field[$o]['help'] 		= $CORE->_e(array('add','100'));
					$field[$o]['class'] 	= "form-control";
					$field[$o]['ontop'] 	= true;
				...
				case "5": { // LISTING ATTRIBUTES			 
				 /************* N-GYS [START]*****************/
					...
					jQuery('#form_auction_type').change(function(e) { if(jQuery('#form_auction_type').val() == '2'){ jQuery('#form-row-rapper-price_current').hide(); jQuery('#form-row-rapper-price_reserve').hide(); jQuery('#form-row-rapper-price_bin').find('.required').css('display','inline-block');} else { jQuery('#form-row-rapper-price_reserve').show();  jQuery('#form-row-rapper-price_current').show(); jQuery('#form-row-rapper-price_bin').find('.required').css('display','none'); } }); }); </script>";
					//$c[$o]['required'] 	= true;
					$c[$o]['defaultvalue'] 	= "0";
					...
					$c[$o]['title'] 	= 'Buy Now Price';
					$c[$o]['name'] 		= "price_bin";
					$c[$o]['type'] 		= "price";
					$c[$o]['class'] 	= "form-control";
				//	$c[$o]['help'] 		= $CORE->_e(array('auction','11'));
					$c[$o]['help'] 		= 'This lets the buyers know that they can buy the watch quickly with this price. If a buyer agrees to this price, the watch will disappear from the listings. Note that you cannot edit the price after the listing is posted and when a bid has been placed on it.';
					$c[$o]['required'] 	= true;	
					$c[$o]['defaultvalue'] 	= "0";	
					$o++;
...
jQuery('#form-row-rapper-post_content .control-label').find('.required').html('');
...
<?php  } }
	...
	function _hook_customfields_custx($c){ 
		global $CORE;
		$o = 50;
		$canEditPrice = true;
		//print_r($_GET['eid']);
		...
		add_action('hook_add_fieldlist', '_hook_customfields_custx',1);
