...
<div class="_searchresultsdata"> 
	...
	<div class="wlt_search_results <?php if($GLOBALS['CORE_THEME']['display']['default_gallery_style'] == "grid"){ echo "grid_style";  }else{ echo "list_style"; } ?>">
		...
		<?php $listing_expiry_date_timestamp = get_post_meta(get_the_id(),'listing_expiry_date_timestamp', true); 
			//if($listing_expiry_date_timestamp >= strtotime(date('Y-m-d H:i:s'))){
