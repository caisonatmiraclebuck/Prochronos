        	 ...
        	 <div class="input-group">
				  ...
				  if(isset($_GET['u'])){				  
					  if(is_numeric($_GET['u'])){
						...
						$companyName = get_user_meta($_GET['u'], 'company_name', true);
              ...
              <script type="application/javascript"> 
					...
					jQuery('#usernamefield').change(function() { customValidateUsername('<?php echo str_replace("http://","",get_home_url()); ?>', this.value, 'ajaxMsgUser')  } );				
			  </script>
			  <hr />
