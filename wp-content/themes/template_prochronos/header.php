...
<?php hook_core_columns_wrapper_inside(); ?>
 ...
 <div id="core_inner_wrap" class="clearfix">   
	...
	<article class="<?php $title = get_the_title();
if($title !== 'Leave Request' && $page_template !== 'tpl-fastauction.php' && $page_template !== 'tpl-slowauction.php') { $CORE->CSS("columns-middle");} else{ echo  'col-md-12 col-sm-12';}?>" id="core_middle_column"><div class="core_middle_wrap"><?php echo $CORE->ERRORCLASS(); ?><div id="core_ajax_callback"></div><?php echo $CORE->BANNER('middle_top'); ?>
